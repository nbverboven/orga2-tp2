...
ASM_fourCombine:
	...
	.ciclo:
		...
		pshufd     xmm2, xmm0, 0x08 ; xmm2 <- [ ----------- | ----------- | src[n-1][2] | src[n-1][0] ]
		pshufd     xmm3, xmm0, 0x0D ; xmm3 <- [ ----------- | ----------- | src[n-1][3] | src[n-1][1] ]
		pshufd     xmm4, xmm1, 0x08 ; xmm4 <- [ ----------- | ----------- | src[n-2][2] | src[n-2][0] ]
		pshufd     xmm5, xmm1, 0x0D ; xmm5 <- [ ----------- | ----------- | src[n-2][3] | src[n-2][1] ]
